...
export const metadata: Metadata = {
  ...
  description: "Hands-on demos of React 19.3: Suspense, ViewTransition, and coordinated reveals.",
};

export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html lang="en" className={`${sora.variable} ${plexMono.variable} ${caveat.variable}`}>
      <body>
